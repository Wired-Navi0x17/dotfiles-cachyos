...
*   [**Start Here**](#repository-structure) - Explore the repository tree layout.
...
*   **Outsources:** Followed the styling and configuration guides from the [agridyne/dotfiles-dt](https://github.com/agridyne/dotfiles-dt) repository.
